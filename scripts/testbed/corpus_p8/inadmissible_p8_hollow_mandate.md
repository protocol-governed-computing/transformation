...
> Every register below is present and correctly shaped. Each records a mandate entry with the cell that makes it actionable left empty, or hedged.
...
|------|------|------|-------------------------------|-----------|------------|
| 1 | 1 | book_library_mgmt::STRUCTURE_CATALOG_STORAGE_V0 | AUTHOR | catalog | — |
| 1 | 2 | book_library_mgmt::CT_PURE_FORM_BOOK_IDENTITY_KEY_V0 | NEW | UNRESOLVED | — |
...
|------|---------|--------|---------|
| book_library_mgmt::CT_PURE_FORM_BOOK_IDENTITY_KEY_V0 |  | title:string, author:string, publication_year:integer | identity_key:string |
