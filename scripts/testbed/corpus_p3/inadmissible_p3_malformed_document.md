...
> The analysis below is the admissible document's. What is wrong is the shape it is carried in — and the mandatory verification pass is gone.
...
| Artifact | Impact Scope | Evidence |
|----------|--------------|----------|
| capability_side_effects::CS_MUTABLE_JSON_V0 | ai_governance, workload | si.topology.impact impacted_count 12, impacted_namespaces ai_governance and workload; si.artifact.refs ref_count 4 |
| capability_side_effects::CS_REGISTRY_V0 | ai_governance | si.topology.impact impacted_count 19, impacted_namespaces ai_governance; si.artifact.refs ref_count 6 |
| capability_side_effects::CS_APPENDONLY_JSONL_V0 | ai_governance | si.topology.impact impacted_count 21, impacted_namespaces ai_governance; si.artifact.refs ref_count 5 |
