...
> The change request declares it touches the catalog. Every capability below is placed under a subdomain the change request never named.
...
|------------|-----------------|------------------------------------------|-------------------|----------------|
| Register a book together with its first physical copy | circulation | OWNED |  | S4 authoring_scope GAP-05 |
| Register a further physical copy against a registered book | circulation | OWNED |  | S4 authoring_scope GAP-06 |
| Update a book's bibliographic information | circulation | OWNED |  | S4 authoring_scope GAP-07 |
| Retire a book record | circulation | OWNED |  | S4 authoring_scope GAP-08 |
| Retire a physical copy | circulation | OWNED |  | S4 authoring_scope GAP-09 |
| Return a retired book record to the registered state | circulation | OWNED |  | S4 authoring_scope GAP-10 |
| Return a retired physical copy to the registered state | circulation | OWNED |  | S4 authoring_scope GAP-11 |
| Search the catalog by subject or title | circulation | OWNED |  | S4 authoring_scope GAP-12 |
| Retrieve a book's complete details with the copies held | circulation | OWNED |  | S4 authoring_scope GAP-13 |
| Confirm the staff member performing an operation is authorized | circulation | OWNED |  | S4 authoring_scope GAP-04 |
| Record every performed catalog operation in the catalog's own audit trail | circulation | OWNED |  | S4 authoring_scope GAP-01 |
...
| Deleting a catalog record | circulation | DEFERRED |  | S1 business_invariants #9 |
