...
|------------|-----------------|------------------------------------------|-------------------|----------------|
| CC_REGISTER_BIBLIOGRAPHIC_WORK_V0 | catalog | OWNED | | S5 scope_boundary Register a book |
...
| Hold a record that can be updated in place | capability_side_effects | SATISFIED |  | S5 cross_subdomain_refs CS_MUTABLE_JSON |
...
| Decide which staff members are authorized | patron | | GAP | S4 gap_register GAP-10 |
...
| Reindex the catalog nightly | catalog | S6 ownership Search the catalog |
