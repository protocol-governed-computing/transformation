...
| CC_SEARCH_CATALOG_V0 | catalog | OWNED |  | S4 authoring_scope GAP-12 |
...
|------------|-----------|-------------------|-------------------------|----------------|
| Read whether a staff member is authorized to perform catalog operations | staff and catalog both |  | GAP | S1 authority_deferrals #1 |
