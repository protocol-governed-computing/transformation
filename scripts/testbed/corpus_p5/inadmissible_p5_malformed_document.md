...
|--------|----------------------------------|------------|
| CR seed §0 Business Purpose | REFINED | Restates the seed's purpose in the phase's own terms. |
...
| Action | Object | Status (IN_SCOPE, DEFERRED) | Source Finding |
|--------|--------|-----------------------------|----------------|
| Register | Book, with its first physical copy | IN_SCOPE | S4 capability_graph Register a book together with its first physical copy |
| Register | Physical copy | IN_SCOPE | S4 capability_graph Register a further physical copy against a registered book |
| Update | Book's bibliographic information | IN_SCOPE | S4 capability_graph Update a book's bibliographic information |
| Retire | Book record | IN_SCOPE | S4 capability_graph Retire a book record |
| Retire | Physical copy | IN_SCOPE | S4 capability_graph Retire a physical copy |
| Reinstate | Book record | IN_SCOPE | S4 capability_graph Return a retired book record to the registered state |
| Reinstate | Physical copy | IN_SCOPE | S4 capability_graph Return a retired physical copy to the registered state |
| Search | Catalog | IN_SCOPE | S4 capability_graph Search the catalog by subject or title, excluding retired books |
| Retrieve | Book's complete details | IN_SCOPE | S4 capability_graph Retrieve a book's complete details with the copies the library holds |
| Delete | Book record or physical copy | DEFERRED | S1 business_invariants #9 |
