...
| Retire a book record | S3 authoring_decisions Retire a book record | CRITICAL | GAP-99 | Nothing in the composition satisfies it. |
...
|------|----|-----------------|------------|----------------|
| catalog | capability_side_effects::CS_MUTABLE_JSN_V0 | capability call | SATISFIED | S3 dependency_discoveries Durable record storage |
