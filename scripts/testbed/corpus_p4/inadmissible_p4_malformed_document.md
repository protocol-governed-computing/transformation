...
> The consolidation below is the admissible document's. What is wrong is the shape it is carried in.
...
| # | Constraint | Source Finding |
|---|-----------|----------------|
| 1 | Each physical copy belongs to exactly one book. | S1 business_invariants #1 |
| 2 | Each book the library holds has exactly one authoritative record. | S1 business_invariants #2 |
| 3 | Each physical copy the library owns has exactly one authoritative record. | S1 business_invariants #3 |
| 4 | No two registered books share the same title, author and publication year. | S1 business_invariants #4 |
| 5 | A book carries at least one subject. | S1 business_invariants #5 |
| 6 | No two physical copies the library owns share the same barcode. | S1 business_invariants #6 |
| 7 | Every business operation performed against the catalog is traceable and auditable. | S1 business_invariants #7 |
| 8 | Only authorized staff perform catalog operations. | S1 business_invariants #8 |
