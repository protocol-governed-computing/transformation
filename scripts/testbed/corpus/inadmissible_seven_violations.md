...
| Term | Definition |
|------|------------|
| Chain | Implemented by CT_COMMIT_BLOCK_V0. The authoritative, ordered, append-only ledger of committed blocks. ("Canonical chain"/"canonical ledger" are synonyms.) |
...
| # | Fact | Certainty |
|---|------|-----------|
| 1 | A canonical chain (ledger) is required. | PROBABLY |
...
| 3 | There is a block-proposal capability. | Defines the input. |  |
