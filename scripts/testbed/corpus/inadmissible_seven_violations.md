...
| Term | Definition |
|------|------------|
| Chain | Implemented by CT_COMMIT_BLOCK_V0. The authoritative, ordered, append-only ledger of committed blocks. |
...
|------|-----------|
| A canonical chain is required as the authoritative record of committed blocks. | PROBABLY |
...
| There is a block-proposal capability. | Defines the input the chain commit consumes. |  |
