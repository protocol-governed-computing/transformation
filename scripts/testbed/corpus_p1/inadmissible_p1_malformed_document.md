...
| Term | Source Finding |
|---|---|
| book_library_mgmt | CR seed §2 Business Vocabulary #1 |
| Catalog | CR seed §2 Business Vocabulary #2 |
| Book | CR seed §2 Business Vocabulary #3 |
| Bibliographic Information | CR seed §2 Business Vocabulary #4 |
| Subject | CR seed §2 Business Vocabulary #5 |
| Physical Copy | CR seed §2 Business Vocabulary #6 |
| Barcode | CR seed §2 Business Vocabulary #7 |
| Catalog Record | CR seed §2 Business Vocabulary #8 |
| Book Details | CR seed §2 Business Vocabulary #9 |
| Obsolete Record | CR seed §2 Business Vocabulary #10 |
| Authorized Staff | CR seed §2 Business Vocabulary #11 |
| Business Operation | CR seed §2 Business Vocabulary #12 |
...
|----|-----------------------------|--------------|
| UNRESOLVED | HIGH | CR seed §4 Known Facts — Business Truths #1 |
