...
|---------|-------------------------------------------------------------------|---------|--------------|
| catalog | NEW_SUBDOMAIN | book_library_mgmt is proposed as a new project, and the library requires a governed catalog management capability it maintains manually today. It extends nothing that exists. | CR seed §1 CR Type #7 |
...
|----|-----------------------------|--------------|
| The proposed name of the project is book_library_mgmt. | HIGH | S0 business_invariants #99 |
...
|--------|----------|------------------|-----------------------------------|--------------|
| Does a retired book keep its subjects, or are they cleared? | Search excludes retired books, so nothing states what a reinstated book is findable by. | YES | HUMAN | CR seed §4 Known Facts — Business Truths #1 |
| Which staff grade may retire a record the library paid for? | Retirement is irreversible in practice even though it is reversible in the model. | NO | HUMAN | CR seed §4 Known Facts — Business Truths #2 |
