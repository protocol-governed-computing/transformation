...
> A subdomain owns what it holds. Every act below reaches outside the catalog: one reads a store it never declared a reach to, one declares a reach it never uses, and one writes into records another subdomain answers for.
...
| book_library_mgmt::WF_SEARCH_CATALOG_V0 | ai_governance::CC_APPEND_AUDIT_EVENT_V0 | CC | SUCCESS -> book_library_mgmt::CC_SEARCH_CATALOG_V0; VIOLATION -> EXIT_REJECTED | S7 new_artifacts CC_SEARCH_CATALOG_V0 |
...
|-----|----------|----------------|
| book_library_mgmt::WF_SEARCH_CATALOG_V0 | ai_governance::RB_AGENT_GOVERNANCE_BINDINGS_V0 | S6 storage_governance A durable record of every book the library catalogs |
