...
> Every step below is bound field by field. What is wrong is what those bindings read from, and one declared output that no step ever produces.
...
|-------|------|--------------------------|-------|----------|----------------|
| book_library_mgmt::CC_CONFIRM_STAFF_AUTHORIZED_V0 | confirm_authorization | INPUT | parameters |  | S7 cc_composition confirm_authorization |
| book_library_mgmt::CC_CONFIRM_STAFF_AUTHORIZED_V0 | confirm_authorization | INPUT | rules | results.CC_NOT_IN_THIS_WORKFLOW_V0.rules | S7 cc_composition confirm_authorization |
| book_library_mgmt::CC_CONFIRM_STAFF_AUTHORIZED_V0 | confirm_authorization | OUTPUT | is_authorized | capability_result.decision | S7 cc_composition confirm_authorization |
...
| book_library_mgmt::CC_CLAIM_BOOK_IDENTITY_V0 | claim_identity | OUTPUT | address | capability_result.registry_handle | S7 cc_composition claim_identity |
...
| book_library_mgmt::WF_REGISTER_BOOK_V0 | book_library_mgmt::CC_REGISTER_BOOK_V0 | INPUT | identity_key | results.CC_RESOLVE_BOOK_IDENTITY_V0.identity_key | S7 execution_topology CC_REGISTER_BOOK_V0 |
...
| book_library_mgmt::CC_CONFIRM_STAFF_AUTHORIZED_V0 | OUTPUT | audit_reference | string | YES |  | A reference nothing in this design produces |
