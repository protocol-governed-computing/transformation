...
| Register a physical copy | The book it names is not registered. | book_library_mgmt::WF_REGISTER_PHYSICAL_COPY_V0 | book_library_mgmt::CC_VERIFY_BOOK_EXISTS_V0 | NOT_FOUND | S0 operation_refusals #4 |
