...
> Every artifact below is designed and named. What is wrong is how it says it will be built — the module behind a transform, the generator behind a file, the values behind a vocabulary.
...
| --------- | -------- | ---------- | ----------- | ----------------------- | ----------------------------- | -------------------------------- | ---------------- |
| book_library_mgmt::CT_PURE_FORM_BOOK_IDENTITY_KEY_V0 |  | execute | PURE_FORM_BOOK_IDENTITY_KEY | atom | ct_pure |  | S7 new_artifacts CT_PURE_FORM_BOOK_IDENTITY_KEY_V0 |
| book_library_mgmt::CT_PURE_FORM_BOOK_IDENTITY_KEY_V0 | ai_governance.implementation.capability_transforms.atoms.ct_pure_form_book_identity_key_v0 | run | PURE_FORM_BOOK_IDENTITY_KEY | atom | ct_pure | maybe | S7 new_artifacts CT_PURE_FORM_BOOK_IDENTITY_KEY_V0 |
...
|----------|-----------|-------------------|----------------|
| book_library_mgmt::EV_BOOK_REGISTERED_V0 | scripts/emit_events.py | design_intent | S7 new_artifacts EV_BOOK_REGISTERED_V0 |
| book_library_mgmt::EV_BOOK_REGISTERED_V0 | transformation.build.emit:events |  | S7 new_artifacts EV_BOOK_REGISTERED_V0 |
| book_library_mgmt::EV_UNDESIGNED_MOMENT_V0 |  | design_intent | S7 new_artifacts EV_BOOK_REGISTERED_V0 |
