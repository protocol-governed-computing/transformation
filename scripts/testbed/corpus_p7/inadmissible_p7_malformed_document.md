...
> The design below is the admissible document's. What is wrong is the shape it is carried in.
...
| capability_side_effects::CS_REGISTRY_V0 | ADOPT |  | Register-if-absent gives the atomic claim duplicate prevention needs, on a key the catalog forms. | S6 ownership Claim a value once so a second claim on it fails |
...
|----------|----------|-------|----------------|
| book_library_mgmt::AC_LIBRARY_STAFF_V0 | type | UNRESOLVED | S5 provisional_codes AC_LIBRARY_STAFF_V0 |
...
| Operation | Refused When | Deferred To | Source Finding |
|-----------|--------------|-------------|----------------|
| NONE IDENTIFIED |
