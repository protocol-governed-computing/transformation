...
> Every row below assigns a binding identity. What is wrong with each is where it says the decision came from — and one workflow this design names has no topology at all.
...
|----------|---------------|------------|----------------|
| The catalog is a new subdomain | Nothing in the composition manages a library catalog | A new subdomain namespace with its own actor, stores, bindings and operations | S6 placement_register #1 |
...
|------------|------------------------------------------------|------|---------|-----------------|--------|----------------|
| The authorized staff member who performs a CC_REGISTER_BOOK_V0 operation | AC | book_library_mgmt::AC_LIBRARY_STAFF_V0 | The actor whose authorization every catalog operation binds | catalog | NEW | S5 provisional_codes AC_LIBRARY_STAFF_V0 |
...
|----------|----------|-------|----------------|
| book_library_mgmt::AC_LIBRARY_STAFF_V0 | type | ENDUSER |  |
...
|------------|-----------------------------------------------------------|---------------|---------|----------------|
| BOOKS | CS_MUTABLE_JSON_V0 | book_library_mgmt/catalog/books.json | book_library_mgmt::CC_REGISTER_BOOK_V0 | S5 business_objects #99 · S6 storage_governance A durable record of every book the library catalogs |
