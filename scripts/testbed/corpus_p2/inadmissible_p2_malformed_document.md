...
| Belief | Result (VERIFIED, NOT_FOUND, INSUFFICIENT_EVIDENCE) | Source Finding |
|--------|------------------------------------------------------|----------------|
| book_library_mgmt does not appear to be part of the current software baseline. | ABSENT | S1 system_beliefs #1 |
...
| Uniqueness is available as a declared side effect, keyed on a single value. | UNRESOLVED | OBSERVED | S1 identity_and_sameness #1 |
